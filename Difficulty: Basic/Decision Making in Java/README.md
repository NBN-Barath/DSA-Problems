...
<pre data-cur="cursor"><span style="font-size: 18px;"><strong>Input: </strong>n = 4, m = 8</span>
...
<pre data-cur="cursor"><span style="font-size: 18px;"><strong>Input: </strong>n = 8, m = 8</span>
